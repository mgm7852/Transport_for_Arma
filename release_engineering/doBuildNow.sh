...
#
#
# this below is used for source_code file name and _autogenerated storage directory name
PACKAGE_DIRNAME="v."
PACKAGE_DIRNAME+=$MAJORVERSION
PACKAGE_DIRNAME+=$SEMANTIC_VERSIONED_FILENAME_DOT
PACKAGE_DIRNAME+=$MINORVERSION
PACKAGE_DIRNAME+=$SEMANTIC_VERSIONED_FILENAME_DOT
PACKAGE_DIRNAME+=$PATCHVERSION
PACKAGE_DIRNAME+=$SEMANTIC_VERSIONED_FILENAME_DOT
PACKAGE_DIRNAME+=$SEMANTIC_VERSIONED_FILENAME_WORDBUILD
PACKAGE_DIRNAME+=$BUILDID
#
#======================================#
...
mkdir -p $STAGING_PATH/'_INSTALL_ON_YOUR_SERVER__PBO_Files/0__Epoch_AutoStart_PBO____server-side'
mv $SERVER_SIDE_PBO_OUT_FULLPATH $STAGING_PATH/'_INSTALL_ON_YOUR_SERVER__PBO_Files/0__Epoch_AutoStart_PBO____server-side/'
#======================================##======================================#
# move client-side PBO into a clearly marked directory
mkdir -p $STAGING_PATH/'_INSTALL_ON_YOUR_SERVER__PBO_Files/1__Epoch_Altis_Mission_PBO_____client-side'
mv $CLIENT_SIDE_PBO_OUT_FULLPATH $STAGING_PATH/'_INSTALL_ON_YOUR_SERVER__PBO_Files/1__Epoch_Altis_Mission_PBO_____client-side/'
#======================================##======================================#
# Copy documentation
...
SOURCE_CODE_FILENAME="source_code_"
SOURCE_CODE_FILENAME+=$PACKAGE_DIRNAME
SOURCE_CODE_FILENAME+=$SEMANTIC_VERSIONED_FILENAME_DOT
SOURCE_CODE_FILENAME+=$SEMANTIC_VERSIONED_FILENAME_EXTENSION
# Now pack the cloned source code (under staging) into a single ultra compressed 7zip archive file
# ref:	https://sevenzip.osdn.jp/chm/cmdline/switches/method.htm
# ref:	http://stackoverflow.com/a/28474846
$SEVENZ_BINARY_PATH a -bd -bb0 -t7z $SOURCE_CODE_FILENAME $STAGING_PATH/source_code/*
...
mv $STAGING_PATH/$SOURCE_CODE_FILENAME $STAGING_PATH/source_code/
#
#
...
#
mkdir $STORAGE_ROOTPATH/$PACKAGE_DIRNAME
mv $STAGING_PATH/* $STORAGE_ROOTPATH/$PACKAGE_DIRNAME
#
############
# all done
############
