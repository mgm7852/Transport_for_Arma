//H
//H ~~
//H $FILE$		:	<mission>/custom/mgmTfA/mgmTfA_scr_server_initCreateObjectCATP01.sqf
...
if (mgmTfA_configgv_serverVerbosityLevel>=5) then {diag_log format ["[mgmTfA] [mgmTfA_scr_server_initCreateObjectCATP01.sqf]  [V5]          Spawning an AI character as the TaxiCorp dispatcher at this Call-a-Taxi Point"];};
...
if (true) then {
	...
	// posture work
	if (mgmTfA_configgv_serverVerbosityLevel>=5) then {diag_log format ["[mgmTfA] [mgmTfA_scr_server_initCreateObjectCATP01.sqf]  [V5]          uiSleep'ing 0.05 seconds before executing SetPosturePhase2"];};
	uiSleep 0.05;
