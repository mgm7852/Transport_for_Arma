//H
//H ~~
//H $FILE$		:	<mission>/custom/mgmTfA/mgmTfA_fnc_server_TA_ServicePhase04_SendResponse_Charge1stMileFeeRequestActioned.sqf
//H $PURPOSE$	:	This function sends the response that we have just charged the requestor TaxiAnywhere 1st Mile Fee
//H ~~
//H
//HH
//HH ~~
//HH	Example usage	:	UPDATE THIS					_null	=	[_clickNGoRequestorClientIDNumber, _clickNGoRequestorPosition3DArray, _clickNGoRequestorPlayerUIDTextString, _clickNGoRequestorProfileNameTextString] spawn mgmTfA_fnc_server_TA_ServicePhase04_SendResponse_Charge1stMileFeeRequestActioned;
...
if (_thisFileVerbosityLevelNumber>=5) then {diag_log format ["[mgmTfA] [mgmTfA_fnc_server_TA_ServicePhase04_SendResponse_Charge1stMileFeeRequestActioned.sqf]  [TV5] EXITING SCRIPT NOW."];};//dbg
// EOF