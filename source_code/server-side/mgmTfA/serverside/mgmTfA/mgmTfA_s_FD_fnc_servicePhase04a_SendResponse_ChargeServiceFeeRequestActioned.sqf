//H
//H ~~
//H $FILE$		:	<mission>/custom/mgmTfA/mgmTfA_s_FD_fnc_servicePhase04a_SendResponse_ChargeServiceFeeRequestActioned.sqf
//H $PURPOSE$	:	This function sends the response that we have just charged the requestor FixedDestinationTaxi Service Fee
//H ~~
//H
//HH
//HH ~~
//HH	Example usage	:	UPDATE THIS					_null	=	[_FD_RequestorClientIDNumber, _FD_RequestorPosition3DArray, _FD_RequestorPlayerUIDTextString, _FD_RequestorProfileNameTextString] spawn mgmTfA_s_FD_fnc_servicePhase04a_SendResponse_ChargeServiceFeeRequestActioned;
...
if (_thisFileVerbosityLevelNumber>=5) then {diag_log format ["[mgmTfA] [mgmTfA_s_FD_fnc_servicePhase04a_SendResponse_ChargeServiceFeeRequestActioned.sqf]  [TV5] EXITING SCRIPT NOW."];};//dbg
// EOF