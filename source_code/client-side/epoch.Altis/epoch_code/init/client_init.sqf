...
if (hasInterface) then {
	[] call compile preprocessFileLineNumbers "custom\mgmTfA\mgmTfA_scr_client_init.sqf";
};
//==========
...
[] call compile preprocessFileLineNumbers "custom\mgmTfA\mgmTfA_scr_client_onPlayerRespawn.sqf";
//================================================================================
