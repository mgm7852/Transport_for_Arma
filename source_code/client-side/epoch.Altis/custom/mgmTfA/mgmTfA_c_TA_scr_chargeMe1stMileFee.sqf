...
if (((vehicle player) getVariable ["mgmTfAisTATaxi", false])) then {
	...
	if (_playerAuthorizedToPayBool) then {
		if (_TA1stMileFeeNeedToBePaidBool) then {
			...
			if (mgmTfA_configgv_taxiAnywhereTaxisAbsoluteMinimumJourneyFeeInCryptoNumber > 0) then {
				...
				_msg2HintTextString = parsetext format ["<img size='6' image='custom\mgmTfA\img\mgmTfA_c_CO_img_warningSign.jpg'/><br/><br/><t size='1.40' color='#FF0037'>SORRY %1!<br/><br/>1ST MILE FEE<br/>HAS ALREADY<br/>BEEN PAID<br/><br/>", (profileName)];
				...
				// do 1stMileFeePayRequestor comms
				_msg2HintTextString = parsetext format ["<img size='6' image='custom\mgmTfA\img\mgmTfA_c_CO_img_warningSign.jpg'/><br/><br/><t size='1.40' color='#FF0037'>SORRY %1!<br/><br/>1ST MILE FEE<br/>IS DISABLED<br/><br/>", (profileName)];
	...
	if (_playerAuthorizedToPayBool && _TA1stMileFeeNeedToBePaidBool) then {
		...
		if (_playerCashNumber >= mgmTfA_configgv_taxiAnywhereTaxisAbsoluteMinimumJourneyFeeInCryptoNumber) then {
			...
			_msg2HintTextString = parsetext format ["<img size='6' image='custom\mgmTfA\img\mgmTfA_c_CO_img_cannotAfford.jpg'/><br/><br/><t size='1.40' color='#00FF00'>%1<br/><br/>SORRY BUT YOU<br/>CANNOT AFFORD<br/>THE 1ST MILE FEE<br/><br/>%2 CRYPTO<br/><br/>HAVE A NICE DAY!<br/>", (profileName), (str mgmTfA_configgv_taxiAnywhereTaxisAbsoluteMinimumJourneyFeeInCryptoNumber)];
	...
	// with hint
	_msg2HintTextString = parsetext format ["<img size='6' image='custom\mgmTfA\img\mgmTfA_c_CO_img_warningSign.jpg'/><br/><br/><t size='1.40' color='#00FF00'><br/>SORRY %1!<br/><br/><br/>YOU CANNOT PAY<br/>TAXI ANYWHERE<br/>1ST MILE FEE<br/><br/>AS YOU ARE<br/>NOT IN A<br/>TAXI ANYWHERE<br/>VEHICLE<br/><br/>", (profileName)];
	hint _msg2HintTextString;
	// with systemChat
