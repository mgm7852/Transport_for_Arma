...
if ((vehicle player) != player) exitWith {
	...
	// with hint
	_msg2HintTextString = parsetext format ["<img size='6' image='custom\mgmTfA\img\mgmTfA_c_CO_img_warningSign.jpg'/><br/><br/><t size='1.40' color='#00FF00'>SORRY %1!<br/>YOU MAY NOT PLACE<br/>A BOOKING FROM<br/>INSIDE ANOTHER VEHICLE", (profileName)];
...
if (_bookingPermitted) then {
	...
	if (mgmTfA_dgv_thisPlayerCanOrderTATaxiViaHotkey) then {
		...
		if (_playerCanAffordRequestedJourneyCostBool) then {
			...
			_msg2HintTextString 						= parsetext format ["<img size='6' image='custom\mgmTfA\img\mgmTfA_c_TA_img_chooseDestinationGlobe.jpg'/><br/><br/>AWAITING INPUT<br/><br/>SINGLE LEFT CLICK<br/>TO SET DESTINATION"];
			hint 										_msg2HintTextString;
			...
			_msg2HintTextString = parsetext format ["<img size='6' image='custom\mgmTfA\img\mgmTfA_c_CO_img_paymentReceivedThanks.jpg'/><br/><br/><t size='1.40' color='#00FF00'>%1<br/><br/>THANKS FOR PAYING<br/>THE CLICKNGO BOOKING FEE<br/>%2 CRYPTO<br/><br/>PLEASE WAIT<br/>", (profileName), (str mgmTfA_configgv_taxiAnywhereTaxisNonRefundableBookingFeeCostInCryptoNumber)];
			...
			_msg2HintTextString = parsetext format ["<img size='6' image='custom\mgmTfA\img\mgmTfA_c_CO_img_cannotAfford.jpg'/><br/><br/><t size='1.40' color='#FF0037'>SORRY %1<br/><br/>YOU CANNOT AFFORD<br/>clickNGo MINIMUM<br/>PREPAY FEE<br/>%2 CRYPTO<br/><br/>PLEASE TRY AGAIN<br/>WHEN YOU HAVE ENOUGH CASH<br/><br/>THANK YOU<br/>", (profileName), (str (round _journeyInitialCostInCryptoNumber))];
		...
		_msg2HintTextString = parsetext format ["<img size='6' image='custom\mgmTfA\img\mgmTfA_c_CO_img_warningSign.jpg'/><br/><br/><t size='1.40' color='#00FF00'>SORRY %1!<br/><br/>YOU MAY NOT<br/>PLACE A BOOKING<br/>AT THIS TIME.<br/><br/>YOU ALREADY HAVE A<br/>TAXI SERVING YOU<br/>CURRENTLY", (profileName)];
		hint _msg2HintTextString;
