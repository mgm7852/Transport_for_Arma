...
if (mgmTfA_dgv_purchasingPowerCheckAndPAYGChargeForTimeTicksFunctionCurrentlyRunningBool) exitWith {if (mgmTfA_configgv_clientVerbosityLevel>=5) then {diag_log format ["[mgmTfA] [mgmTfA_c_TA_fnc_purchasingPowerCheckAndPAYGChargeForTimeTicks.sqf] [TV5]          I have been SPAWN'd however (mgmTfA_dgv_purchasingPowerCheckAndPAYGChargeForTimeTicksFunctionCurrentlyRunningBool) is  already active. I will now terminate this function."];};};
...
mgmTfA_dgv_purchasingPowerCheckAndPAYGChargeForTimeTicksFunctionCurrentlyRunningBool = true;
...
if (_thisFileVerbosityLevelNumber>=8) then {diag_log format ["[mgmTfA] [mgmTfA_c_TA_fnc_purchasingPowerCheckAndPAYGChargeForTimeTicks.sqf] [TV8]          Just set this to true => (mgmTfA_dgv_purchasingPowerCheckAndPAYGChargeForTimeTicksFunctionCurrentlyRunningBool).		Current time is: (%1).", (str (time))];};
