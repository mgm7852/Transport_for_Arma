...
_mgmTfAActionIDPayPAYGInitialFeeAction = _VehEntered addAction ["<img image='custom\mgmTfA\img_actmenu\mgmTfA_ico_client_taxiPayment.paa' /><t color=""#FF0000""> Pay PAYG Initial Fee</t>", "custom\mgmTfA\mgmTfA_scr_client_clickNGoTaxiPayNow.sqf",[_VehEntered], -5, false, true,"", "(vehicle player) == _target"];
// save actionID
